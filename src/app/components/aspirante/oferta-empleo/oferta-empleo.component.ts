...
export class OfertaEmpleoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._aspirantessolicitadosService.getAspirantessolicitados().subscribe((resp:any)=>{
      ...
      this.httpClient.get('https://agencialaboralproyecto.pythonanywhere.com/api/aspirantes/').subscribe((respAspirantes:any)=>{
        this.listaAspirantes=respAspirantes;
      })
      this.httpClient.get('https://agencialaboralproyecto.pythonanywhere.com/api/representantes/').subscribe((respRepresentantes:any)=>{
        this.listaRepresentantes=respRepresentantes;
      })
      this.httpClient.get('https://agencialaboralproyecto.pythonanywhere.com/api/empresas/').subscribe((respEmpresas:any)=>{
        this.listaEmpresas=respEmpresas;
      })
      this.httpClient.get('https://agencialaboralproyecto.pythonanywhere.com/api/profesiones/').subscribe((respProfesiones:any)=>{
  ...
  aceptar(idOferta) {
    ...
    this.httpClient.put('https://agencialaboralproyecto.pythonanywhere.com/api/aspirantessolicitados/'+idOferta, this.formEmpresa.value).subscribe(
  ...
  rechazar(idOferta) {
    ...
    this.httpClient.put('https://agencialaboralproyecto.pythonanywhere.com/api/aspirantessolicitados/'+idOferta, this.formEmpresa2.value).subscribe(
      resp => console.log(resp),
      err => console.log(err)
