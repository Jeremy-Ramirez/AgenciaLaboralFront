...
export class SolicitudesContratacionComponent implements OnInit {
  ...
  getSolicitudes(){
    this.http.get('https://agencialaboralproyecto.pythonanywhere.com/api/solicitudes/').subscribe((solicitudes:any)=>{
  ...
  aceptarAspirante(id : any){
    for(let asp of this.aspirantes){
      if(asp.usuario_idusuario==id){
        ...
        /*this.http.patch<any>("https://agencialaboralproyecto.pythonanywhere.com/api/aspirantes/"+asp.idaspirante,formData,{headers: headers}).subscribe(
